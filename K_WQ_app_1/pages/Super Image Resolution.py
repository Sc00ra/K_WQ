...
st.set_page_config(layout="wide", page_title="💧🛰️ Water qualityby Sentinel-2 and Super Image Resolution")
...
st.subheader("💧🛰️ Water quality and Super Image Resolution")
